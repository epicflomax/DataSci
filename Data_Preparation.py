...
label = data["FiErg"]
features = data[["KT","Inst", "Adr",  "Ort", "Typ", "RWStatus", "Akt", "SL", "WB", "AnzStand","SA","PtageStatT","AustStatT","NeugStatT","Ops","Gebs","CMIb","CMIn",
...
missing_percentage = features.isnull().mean() * 100
...
missing_percentage_cat = (cat_features.isnull().sum() / len(cat_features)) * 100
